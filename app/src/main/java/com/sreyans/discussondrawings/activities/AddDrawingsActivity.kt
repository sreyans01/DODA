...
class AddDrawingsActivity : AppCompatActivity() {
    ...
    val pickMedia = registerForActivityResult(ActivityResultContracts.PickVisualMedia()) { uri ->
        if (uri != null) {
                ...
                viewModel.getDrawingImageUrl(uri)
                    .observeOnce(this@AddDrawingsActivity, Observer { msg ->
                        when (msg.status) {
                            ...
                            Status.ERROR -> {
                                UIUtils.showToast(this@AddDrawingsActivity, msg.message)
                            }
                            else -> {
            ...
            UIUtils.showToast(this@AddDrawingsActivity, R.string.select_drawing)
        }
    }
    ...
    fun handleListeners() {
        ...
        binding.uploadDrawingBtn.setOnClickListener {
            if (!TextUtils.isEmpty(binding.title.text)) {
                ...
                UIUtils.showToast(this@AddDrawingsActivity, R.string.title_cannot_be_empty)
            }
        }
